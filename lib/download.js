...
var _validateTargetData = function _validateTargetData(lgCode) {
  if (configFile.target === undefined) {
    configFile.target = {};
  };
  if (configFile['target'][lgCode] === undefined) {
    configFile['target'][lgCode] = [];
  };
};
